...
.method constructor <init>(Landroid/widget/SeekBar;)V
    ...
    .line 36
    iput-object v0, p0, Landroidx/appcompat/widget/j;->c:Landroid/content/res/ColorStateList;

    .line 37
    iput-object v0, p0, Landroidx/appcompat/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 43
    iput-object p1, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
...
.method private d()V
    ...
    .line 128
    iget-object v0, p0, Landroidx/appcompat/widget/j;->b:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_41

    iget-boolean v0, p0, Landroidx/appcompat/widget/j;->e:Z
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/j;->c:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
...
.method a(Landroid/graphics/Canvas;)V
    ...
    .line 166
    iget-object v0, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
    ...
    .line 168
    iget-object v2, p0, Landroidx/appcompat/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 169
    iget-object v3, p0, Landroidx/appcompat/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
    ...
    .line 177
    iget-object v3, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
    ...
    .line 179
    iget-object v4, p0, Landroidx/appcompat/widget/j;->b:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 84
    :cond_a
    iput-object p1, p0, Landroidx/appcompat/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 95
    :cond_2e
    iget-object p1, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/af;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 57
    iget-object p2, p0, Landroidx/appcompat/widget/j;->a:Landroid/widget/SeekBar;
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/af;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 61
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/j;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1, v1}, Landroidx/appcompat/widget/af;->a(II)I
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/af;->e(I)Landroid/content/res/ColorStateList;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/j;->c:Landroid/content/res/ColorStateList;

    .line 71
    iput-boolean p2, p0, Landroidx/appcompat/widget/j;->e:Z
