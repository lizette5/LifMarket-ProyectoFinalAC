...
.method private a()Landroid/support/v4/media/session/MediaSessionCompat$e;
    ...
    invoke-virtual {v1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->h()Landroid/support/v4/media/session/MediaSessionCompat$a;
...
.method private a(Landroid/support/v4/media/session/MediaSessionCompat$b;)V
    ...
    invoke-direct {v1, v0, v2, v2}, Landroidx/media/b$a;-><init>(Ljava/lang/String;II)V

    invoke-interface {p1, v1}, Landroid/support/v4/media/session/MediaSessionCompat$b;->a(Landroidx/media/b$a;)V
...
.method private b(Landroid/support/v4/media/session/MediaSessionCompat$b;)V
    ...
    .line 1895
    invoke-interface {p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->a(Landroidx/media/b$a;)V
...
.method public onCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 1555
    :goto_2c
    invoke-static {p1, v3, v2}, Landroidx/core/app/f;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V

    const-string v1, "android.support.v4.media.session.SESSION_TOKEN2"

    .line 1558
    invoke-virtual {p2}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->c()Landroidx/versionedparcelable/d;

    move-result-object p2

    .line 1557
    invoke-static {p1, v1, p2}, Landroidx/versionedparcelable/a;->a(Landroid/os/Bundle;Ljava/lang/String;Landroidx/versionedparcelable/d;)V
    ...
    invoke-virtual {v1, p1, p2, p3}, Landroid/support/v4/media/session/MediaSessionCompat$a;->a(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    :try_end_be
    .catch Landroid/os/BadParcelableException; {:try_start_d .. :try_end_be} :catch_bf
...
.method public onCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->a(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    ...
    :try_end_10e
    .catch Landroid/os/BadParcelableException; {:try_start_d .. :try_end_10e} :catch_10f
